...
if exist %VCVARSALL_2017_BAT% call %VCVARSALL_2017_BAT% amd64 && goto compile
...
:compile_dll
nvcc -arch compute_30 src\ebsynth.cu -m64 -O6 -w -I "include" -o "bin\ebsynth.dll" --shared -Xcompiler "/DEBSYNTH_API=\"__declspec(dllexport)\" /DNDEBUG /Ox /Oy /Gy /Oi /fp:fast" -Xlinker "/IMPLIB:\"lib\ebsynth.lib\"" || goto error
goto :EOF 
